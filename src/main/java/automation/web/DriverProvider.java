...
public class DriverProvider {
    ...
    /**
     * Start Selenium4 driver on Chrome (UNDER CONSTRUCTION)
     * @return
     */
    private static WebDriver getSelenium4Driver() {
...
///// REMOTE  DRIVERS
    ...
    static public WebDriver getBrowserStackDriverProxy(String testName) throws Exception {
        ...
        caps.setCapability("project", System.getProperty("config"));
